...
import com.social.quizme.SpinWheel.LuckyWheelView;
import com.social.quizme.SpinWheel.model.LuckyItem;
import com.social.quizme.databinding.ActivitySpinnerBinding;
...
public class SpinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        luckyItem.textColor=Color.parseColor("#ffffff");
        data.add(luckyItem);
        ...
        luckyItem2.color= Color.parseColor("#eceff1");
        luckyItem2.textColor=Color.parseColor("#212121");
        data.add(luckyItem2);
        ...
        luckyItem3.color= Color.parseColor("#00cf00");
        data.add(luckyItem3);
        ...
        luckyItem6.textColor=Color.parseColor("#212121");
        luckyItem.color= Color.parseColor("#000000");

//        luckyItem6.color= Color.parseColor("#eceff1");
        ...
        binding.spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //random number genrator kara data hu
    ...
    void updateCash(int index){
        ...
        database.collection("users")
                //document hauchiu ko data user ku update karuchu
